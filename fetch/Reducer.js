...
export default function Reducer(state = initialState, action) {
  switch(action.type) {
    ...
    case ActionTypes.GET_ONE_WEEK_DATA_ACTION_SUCCESS:
      return {
        state: ActionTypes.GET_ONE_WEEK_DATA_ACTION_SUCCESS,
        isLoading: false,
        oneWeekData: action.data
      }
  
    case ActionTypes.GET_ONE_WEEK_DATA_ACTION_REQUEST:
      return {
        state: ActionTypes.GET_ONE_WEEK_DATA_ACTION_REQUEST,
        isLoading: true,
      }
  
    case ActionTypes.GET_ONE_WEEK_DATA_ACTION_FAILURE:
      return {
